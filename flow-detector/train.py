...
# 数据路径
train_csv = r"D:\AI\AI-Based-Whitelist-Traffic-Filtering\flow-detector\data\UNSW_NB15_training-set.csv"
test_csv = r"D:\AI\AI-Based-Whitelist-Traffic-Filtering\flow-detector\data\UNSW_NB15_testing-set.csv"
